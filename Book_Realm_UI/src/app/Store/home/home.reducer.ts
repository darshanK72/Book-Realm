...
import { getBookSectionsFailure, getBookSectionsSuccess, getHeroSectionsFailure, getHeroSectionsSuccess, getHomeSectionsFailure, getHomeSectionsSuccess, getMediumBannerSectionsFailure, getMediumBannerSectionsSuccess, getSmallBannerSectionsSuccess, getSmallBannerSectionsFailure, getLargeBannerSectionsSuccess, getLargeBannerSectionsFailure } from "./home.actions";
...
export const homeReducer = createReducer(
    ...
    on(getLargeBannerSectionsSuccess, (state, action) => ({
        ...state,
        largeBannerSections: [...state.largeBannerSections, {
            sectionId: action.payload.sectionId,
            largeBanners: action.payload.largeBanners
        }],
        error: null,
        success: action.payload.success
    })),
    on(getLargeBannerSectionsFailure, (state, action) => ({
        ...state,
        error: action.payload.error,
        success: null
    }))
